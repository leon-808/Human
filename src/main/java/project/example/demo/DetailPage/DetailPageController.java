...
public class DetailPageController{
	...
	@ResponseBody
	public String getDetail(@PathVariable("rname") String rname,
	...
	@ResponseBody
	public String reviewGetMy(@RequestParam("rname") String rname,
	...
	@ResponseBody
	public String ownerReview(HttpServletRequest req) {
		String retval="ok";
		try {
			String primecode=req.getParameter("primecode");
			String id = req.getParameter("id");
			...
			ddao.ownerReview(primecode,id,content,customid);
		}catch(Exception e) {
			retval="fail";
			e.printStackTrace();
		}
